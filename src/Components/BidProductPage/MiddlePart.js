                ...
                <Row >
                    ...
                    <Col>
                        ...
                        <Row style={{ marginTop: '15px' }}>
                            ...
                            <Col md={8} style={{ paddingLeft: '15px', color: 'white' }}>
                                <small>0.11wETH by  </small> <strong>Allen Waltker</strong><br/>
                        ...
                        <Row style={{ marginTop: '15px' }}>
                            ...
                            <Col md={8} style={{ paddingLeft: '15px', color: 'white' }}>
                                <small>0.11wETH by  </small> <strong>Joe Biden</strong><br/>
                                <small>1.30 hours ago</small>
                            </Col>
                        </Row>
                        ...
                        <Row style={{ marginTop: '15px' }}>
                            ...
                            <Col md={8} style={{ paddingLeft: '15px', color: 'white' }}>
                                <small>0.11wETH by  </small> <strong>Sonial Mridha</strong><br/>
                                <small>1.35 hours ago</small>
                            </Col>
                        </Row>
