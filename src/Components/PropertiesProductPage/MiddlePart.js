                ...
                <Row >
                    ...
                    <Col>
                        ...
                        <Row style={{marginTop:'15px'}}>
                            <Col md={4}>
                                <Card style={{backgroundColor:'#3b3b59', color:'white'}}>
                                    <Card.Body>Genus <br/> Elephant</Card.Body>
                                </Card>
                            </Col>
                            <Col md={4}>
                                <Card style={{backgroundColor:'#3b3b59', color:'white'}}>
                                    <Card.Body>Type<br/> YOUNGLING </Card.Body>
                                </Card>
                            </Col>
                            <Col md={4}>
                                <Card style={{backgroundColor:'#3b3b59', color:'white'}}>
                                    <Card.Body>Skin <br/>Blue</Card.Body>
                                </Card>
                            </Col>
                        </Row>
                        ...
                        <Row style={{marginTop:'15px'}}>
                            <Col md={3}>
                                <Card style={{backgroundColor:'#3b3b59', color:'white'}}>
                                    <Card.Body><small>HEADWEAR </small><br/> <small>Pearl Cap</small></Card.Body>
                                </Card>
                            </Col>
                            <Col md={3}>
                                <Card style={{backgroundColor:'#3b3b59', color:'white'}}>
                                    <Card.Body>EYES<br/><small>Smky Tear</small></Card.Body>
                                </Card>
                            </Col>
                            <Col md={3}>
                                <Card style={{backgroundColor:'#3b3b59', color:'white'}}>
                                    <Card.Body>Shoes <br/><small>DORE RUN</small></Card.Body>
                                </Card>
                            </Col>
                        </Row> 
